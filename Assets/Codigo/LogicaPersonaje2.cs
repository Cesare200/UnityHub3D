...
public class LogicaPersonaje2 : MonoBehaviour
{
    ...
    // Distancia de detección de obstáculos al frente
    ...
    private void FixedUpdate()
    {
        ...
        // Verificar si hay obstáculos al frente
        RaycastHit hit;
        if (Physics.Raycast(transform.position, transform.forward, out hit, distanciaDeteccion))
        {
            // Si hay un obstáculo, calcular una nueva posición de destino aleatoria dentro del área
            CalculateNewTargetPosition();
        }
